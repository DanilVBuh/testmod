...
public class RegistryHandler {
    ...
    public static final RegistryObject<Block> PHILOCLITE_BLOCK = BLOCKS.register("philoclite_block", MiodiumBlock::new);
    public static final RegistryObject<Block> PHILOCLITE_ORE = BLOCKS.register("philoclite_ore", MiodiumOre::new);
    ...
    public static final RegistryObject<Item> PHILOCLITE_BLOCK_ITEM = ITEMS.register("philoclite_block", () -> new BlockItemBase(MIODIUM_BLOCK.get()));
    public static final RegistryObject<Item> PHILOCLITE_ORE_ITEM = ITEMS.register("philoclite_ore", () -> new BlockItemBase(MIODIUM_ORE.get()));
